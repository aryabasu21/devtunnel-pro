...
export class TunnelManager {
  ...
  private tunnelsByName: Map<string, string> = new Map();

  private tunnelsByDevice: Map<string, Set<string>> = new Map();
  ...
  removeTunnel(id: string): void {
    ...
    if (
      ...
      tunnel.ws.readyState === WebSocket.CONNECTING
    ) {
      tunnel.ws.close();
    }
