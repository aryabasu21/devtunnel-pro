          ...
          <div className="px-6 py-3 bg-surface border-b border-border flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                <span
                  className={`w-3 h-3 rounded-full ${serverStatus.status === "running" ? "bg-success" : "bg-destructive"}`}
                />
                <span className="text-sm font-medium">
                  Server:{" "}
                  <span className="text-foreground">{serverStatus.status}</span>
                </span>
              </div>
              <div className="text-sm text-muted-foreground">
                Active tunnels globally:{" "}
                <span className="text-foreground font-semibold">
                  {serverStatus.activeTunnels}
                </span>
              </div>
            </div>
          </div>
                  ...
                  <div className="divide-y divide-border">
                    <div className="p-6 text-center">
                      ...
                      <p className="text-xs text-muted-foreground mb-4 max-w-xs mx-auto">
                        View real-time request logs directly in your CLI
                        terminal where the tunnel is running
                      </p>
                      <div className="bg-surface rounded-lg p-3 text-left max-w-sm mx-auto">
                        ...
                        <code className="text-[10px] font-mono block">
                          <span className="text-success">GET</span> /api/users{" "}
                          <span className="text-success">200</span> 12ms
                          <br />
                          <span className="text-primary">
                            POST
                          </span> /api/login{" "}
                          <span className="text-destructive">401</span> 3ms
                          <br />
                          <span className="text-success">
                            GET
                          </span> /dashboard{" "}
                          <span className="text-success">200</span> 45ms
                        </code>
                      </div>
                    </div>
                  </div>
              ...
              <div className="text-center max-w-md">
                ...
                <div className="mt-4 bg-surface border border-border rounded-lg p-3 text-left">
                  <p className="text-xs text-muted-foreground mb-2">
                    Quick Commands ({getPlatformName(platform)}):
                  </p>
